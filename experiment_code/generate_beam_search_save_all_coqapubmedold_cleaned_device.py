...
device = f"cuda:{args.cuda_device}" if torch.cuda.is_available() or args_cuda_device != '-1' else 'cpu'
...
dataloader = torch.utils.data.DataLoader(questions, batch_size=32)
